...
table_path = _resolve_path("../proj-roboexp/RoboExp_data/assets/objects/models/table/92db5e13fa0c4c27a2689b962fc6305f.glb")
teddy_path = _resolve_path("../proj-roboexp/RoboExp_data/assets/objects/models/teddy/9ddb37ab928246a2acfb4e50c558c49c.glb")
...
if __name__ == "__main__":
    ...
    output_dir = _resolve_path("./taichi_simulator_test/preprocess/data")
    os.makedirs(output_dir, exist_ok=True)
    o3d.io.write_point_cloud(f"{output_dir}/teddy.ply", teddy)
    o3d.io.write_point_cloud(f"{output_dir}/table.ply", table)
