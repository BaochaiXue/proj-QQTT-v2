...
def demo1():
    ...
    #     "./taichi_simulator_test/data/table.ply"
    # )
    ...
    teddy = o3d.io.read_point_cloud(
        _resolve_path("./taichi_simulator_test/data/teddy.ply")
    )
    ...
    np.save(_resolve_path("./taichi_simulator_test/data_prepare/multiple_k_data_prepare/teddy_2k.npy"), points_trajectories)
    np.save(_resolve_path("./taichi_simulator_test/data_prepare/multiple_k_data_prepare/teddy_2k_springY.npy"), spring_Y)
