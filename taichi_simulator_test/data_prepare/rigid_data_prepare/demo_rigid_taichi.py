...
def demo1():
    ...
    table = o3d.io.read_point_cloud(
        _resolve_path("./taichi_simulator_test/data/table.ply")
    )
    ...
    np.save(_resolve_path("./taichi_simulator_test/data_prepare/rigid_data_prepare/table_rigid.npy"), points_trajectories)
