...
# Base directories
data_dir = _resolve_path("data/different_types")
render_dir = _resolve_path("exp_results/indomain_our/output_dynamic")
# render_dir = "./experiments"
combine_dir = _resolve_path("combine")
