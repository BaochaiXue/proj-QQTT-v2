...
| --- | ---: | ---: | ---: | ---: |
| `ffs_cycle_ms` | `131.99` | `172.78` | `204.75` | `610.62` |
| `edgetam_cam0_model_ms` | `0.00` | `0.00` | `0.00` | `0.00` |
| `edgetam_cam1_model_ms` | `63.69` | `124.43` | `263.13` | `548.92` |
| `edgetam_cam2_model_ms` | `57.74` | `103.15` | `144.39` | `492.03` |
| `edgetam_cam0_gate_wait_ms` | `0.00` | `0.00` | `0.00` | `0.00` |
| `edgetam_cam1_gate_wait_ms` | `0.00` | `64.47` | `80.06` | `242.33` |
| `edgetam_cam2_gate_wait_ms` | `52.61` | `85.07` | `112.57` | `383.91` |
