...
- compile mode: `vision-max-autotune-no-cudagraphs`
- dtype: `bfloat16`
...
| Stage | value |
| --- | ---: |
| parallel init max wait ms | `3830.46` |
| camera startup ms | `5006.36` |
| EdgeTAM model load ms | `6571.58` |
| EdgeTAM compile wrap ms | `1150.33` |
| EdgeTAM compile prewarm ms | `n/a` |
| EdgeTAM warmup/first forward ms | `n/a` |
| SAM3.1 model load ms | `10375.58` |
...
| --- | ---: | ---: | ---: | ---: |
| `gpu_util_pct` | `44.00` | `82.00` | `88.00` | `92.00` |
| `memory_util_pct` | `38.00` | `74.00` | `77.00` | `81.00` |
| `memory_used_mb` | `5003.10` | `5071.10` | `5071.10` | `5071.10` |
| `power_w` | `113.65` | `158.66` | `166.97` | `208.34` |
| `sm_clock_mhz` | `232.00` | `232.00` | `232.00` | `1110.00` |
| `mem_clock_mhz` | `14001.00` | `14001.00` | `14001.00` | `14001.00` |
| `temperature_c` | `60.00` | `63.00` | `65.00` | `66.00` |

| Metric | median | p90 | p95 | max |
| --- | ---: | ---: | ---: | ---: |
| `capture_temporal_skew_ms` | `13.25` | `51.99` | `58.72` | `66.61` |
