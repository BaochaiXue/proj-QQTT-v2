...
| Stage | value |
| --- | ---: |
| parallel init max wait ms | `4224.30` |
| camera startup ms | `4889.79` |
| EdgeTAM model load ms | `5406.76` |
| EdgeTAM compile wrap ms | `1182.13` |
| EdgeTAM compile prewarm ms | `n/a` |
| EdgeTAM warmup/first forward ms | `10998.21` |
| SAM3.1 model load ms | `9928.32` |
| SAM3.1 cam0 segment ms | `n/a` |
| SAM3.1 cam1 segment ms | `n/a` |
| SAM3.1 cam2 segment ms | `n/a` |
| FFS runner init ms | `n/a` |
| FFS first run ms | `n/a` |
| session init + prompt add ms | `3.16` |
