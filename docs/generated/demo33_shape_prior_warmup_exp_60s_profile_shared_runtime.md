...
- stage period p50 after warmup: `0.00 ms`
- display packet period p50 after warmup: `0.00 ms`
- groups after warmup: `1605`
...
| --- | ---: | ---: | ---: | ---: |
| `gpu_util_pct` | `28.00` | `85.70` | `99.00` | `100.00` |
| `memory_util_pct` | `24.00` | `52.00` | `54.00` | `58.00` |
| `memory_used_mb` | `3050.66` | `10316.75` | `11650.12` | `17858.75` |
| `power_w` | `30.99` | `298.62` | `359.94` | `364.40` |
| `sm_clock_mhz` | `1080.00` | `2655.00` | `2670.00` | `2670.00` |
| `mem_clock_mhz` | `810.00` | `10251.00` | `10251.00` | `10251.00` |
| `temperature_c` | `52.00` | `60.00` | `65.15` | `69.00` |

## Throughput periods

| Event | median ms | p90 ms | p95 ms | max ms |
| --- | ---: | ---: | ---: | ---: |
| `capture_group_period_ms` | `33.38` | `33.66` | `33.79` | `198.37` |
| `display_packet_publish_period_ms` | `0.00` | `0.00` | `0.00` | `0.00` |
| `edgetam_stage_publish_period_ms` | `73.37` | `73.37` | `73.37` | `73.37` |
| `ffs_stage_publish_period_ms` | `43.86` | `50.42` | `57.45` | `74.78` |
| `filter_output_publish_period_ms` | `0.00` | `0.00` | `0.00` | `0.00` |
| `fusion_publish_period_ms` | `0.00` | `0.00` | `0.00` | `0.00` |
| `gpu_owner_publish_period_ms` | `0.00` | `0.00` | `0.00` | `0.00` |
...
| Metric | median | p90 | p95 | max |
| --- | ---: | ---: | ---: | ---: |
| `capture_temporal_skew_ms` | `11.85` | `24.68` | `27.14` | `43.28` |
