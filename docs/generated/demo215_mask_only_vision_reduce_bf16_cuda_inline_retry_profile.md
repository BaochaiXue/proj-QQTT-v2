...
| Stage | value |
| --- | ---: |
| parallel init max wait ms | `3833.34` |
| camera startup ms | `4863.63` |
| EdgeTAM model load ms | `6349.63` |
| EdgeTAM compile wrap ms | `1726.67` |
| EdgeTAM compile prewarm ms | `n/a` |
| EdgeTAM warmup/first forward ms | `5361.76` |
| SAM3.1 model load ms | `10149.29` |
| SAM3.1 cam0 segment ms | `n/a` |
| SAM3.1 cam1 segment ms | `n/a` |
| SAM3.1 cam2 segment ms | `n/a` |
| FFS runner init ms | `n/a` |
| FFS first run ms | `n/a` |
| session init + prompt add ms | `1.74` |
