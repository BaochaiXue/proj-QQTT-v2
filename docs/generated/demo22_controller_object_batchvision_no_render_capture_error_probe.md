...
| camera startup ms | `4714.12` |
| EdgeTAM model load ms | `1232.05` |
| EdgeTAM compile wrap ms | `0.01` |
| EdgeTAM compile prewarm ms | `1846.06` |
...
| --- | ---: | ---: | ---: | ---: |
| `capture_temporal_skew_ms` | `49.85` | `49.85` | `49.85` | `49.85` |
