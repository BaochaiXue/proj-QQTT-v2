...
| --- | ---: | ---: | ---: | ---: |
| `capture_temporal_skew_ms` | `8.87` | `25.95` | `26.81` | `32.68` |
| `ffs_cycle_ms` | `86.08` | `106.81` | `118.57` | `2804.52` |
| `ffs_gate_wait_ms` | `0.01` | `0.02` | `0.02` | `0.06` |
| `edgetam_cam0_model_ms` | `0.00` | `0.00` | `0.00` | `0.00` |
| `edgetam_cam1_model_ms` | `0.00` | `0.00` | `0.00` | `0.00` |
| `edgetam_cam2_model_ms` | `94.42` | `105.81` | `111.15` | `255.64` |
| `edgetam_cam0_gate_wait_ms` | `0.00` | `0.00` | `0.00` | `0.00` |
| `edgetam_cam1_gate_wait_ms` | `0.00` | `0.00` | `0.00` | `0.00` |
| `edgetam_cam2_gate_wait_ms` | `0.00` | `0.01` | `0.01` | `0.01` |
...
| `ffs_stage_ms` | `0.99` | `1.68` | `2.00` | `3.97` |
| `ffs_h2d_wait_ms` | `0.00` | `0.00` | `0.00` | `0.00` |
| `ffs_cam0_stage_ms` | `0.99` | `1.73` | `2.38` | `3.31` |
| `ffs_cam1_stage_ms` | `0.96` | `1.65` | `1.87` | `3.10` |
| `ffs_cam2_stage_ms` | `1.00` | `1.55` | `1.99` | `3.97` |
