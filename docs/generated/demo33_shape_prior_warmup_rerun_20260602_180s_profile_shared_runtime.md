...
- enabled: `True`
- status: `ready`
- case dir: `/home/xinjie/proj-QQTT-v2/result/demo32_ffs_tapnextpp/demo33_shape_prior_warmup/20260602-201109/case`
- object points0: `9352`
- surface points: `372`
- interior points: `62`
- structure points: `9786`
...
- device index: `0`
- interval s: `0.500`
- samples after warmup: `730`

| Metric | median | p90 | p95 | max |
| --- | ---: | ---: | ---: | ---: |
| `gpu_util_pct` | `21.00` | `68.00` | `100.00` | `100.00` |
| `memory_util_pct` | `17.00` | `36.00` | `45.00` | `58.00` |
| `memory_used_mb` | `1900.12` | `15708.81` | `20344.75` | `24558.75` |
| `power_w` | `26.10` | `172.69` | `300.35` | `386.55` |
| `sm_clock_mhz` | `705.00` | `2670.00` | `2670.00` | `2685.00` |
| `mem_clock_mhz` | `810.00` | `10251.00` | `10251.00` | `10501.00` |
| `temperature_c` | `53.00` | `55.00` | `62.00` | `69.00` |

## Throughput periods

| Event | median ms | p90 ms | p95 ms | max ms |
| --- | ---: | ---: | ---: | ---: |
| `capture_group_period_ms` | `33.39` | `33.64` | `33.76` | `175.11` |
| `display_packet_publish_period_ms` | `0.00` | `0.00` | `0.00` | `0.00` |
| `edgetam_stage_publish_period_ms` | `66.39` | `72.26` | `72.99` | `73.73` |
| `ffs_stage_publish_period_ms` | `44.02` | `51.43` | `60.26` | `98.06` |
...
| Metric | median | p90 | p95 | max |
| --- | ---: | ---: | ---: | ---: |
| `capture_temporal_skew_ms` | `9.28` | `25.76` | `28.08` | `38.84` |
...
| `gpu_owner_total_ms` | `63.16` | `63.16` | `63.16` | `63.16` |
| `gpu_owner_ffs_cycle_ms` | `59.47` | `59.47` | `59.47` | `59.47` |
| `gpu_owner_edgetam_cycle_ms` | `63.16` | `63.16` | `63.16` | `63.16` |
