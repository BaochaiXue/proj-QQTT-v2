...
| --- | ---: | ---: | ---: | ---: |
| `capture_temporal_skew_ms` | `12.77` | `26.45` | `28.07` | `32.79` |
| `ffs_cycle_ms` | `0.00` | `0.00` | `0.00` | `0.00` |
| `ffs_gate_wait_ms` | `0.00` | `0.00` | `0.00` | `0.00` |
| `edgetam_cam0_model_ms` | `101.49` | `141.09` | `156.35` | `395.48` |
| `edgetam_cam1_model_ms` | `0.00` | `0.00` | `0.00` | `0.00` |
| `edgetam_cam2_model_ms` | `95.25` | `132.37` | `196.49` | `412.90` |
