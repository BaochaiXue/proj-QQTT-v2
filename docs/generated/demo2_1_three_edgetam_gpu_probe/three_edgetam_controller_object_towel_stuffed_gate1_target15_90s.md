...
| --- | ---: | ---: | ---: | ---: |
| `capture_temporal_skew_ms` | `11.43` | `27.18` | `30.01` | `33.39` |
| `ffs_cycle_ms` | `0.00` | `0.00` | `0.00` | `0.00` |
| `ffs_gate_wait_ms` | `0.00` | `0.00` | `0.00` | `0.00` |
| `edgetam_cam0_model_ms` | `41.25` | `55.53` | `62.56` | `399.52` |
| `edgetam_cam1_model_ms` | `39.96` | `58.35` | `63.97` | `79.95` |
| `edgetam_cam2_model_ms` | `40.11` | `57.49` | `61.72` | `316.81` |
| `edgetam_cam0_gate_wait_ms` | `69.34` | `97.54` | `103.06` | `953.89` |
| `edgetam_cam1_gate_wait_ms` | `73.73` | `92.78` | `98.42` | `125.94` |
| `edgetam_cam2_gate_wait_ms` | `69.40` | `96.04` | `101.99` | `941.18` |
