...
def main() -> int:
    ...
    run([python, "scripts/harness/visual_compare_masked_pointcloud.py", "--help"])
    run([python, "scripts/harness/visual_compare_masked_camera_views.py", "--help"])
    ...
    run([python, "-m", "unittest", "-v", "tests.test_masked_pointcloud_compare_smoke"])
    run([python, "-m", "unittest", "-v", "tests.test_original_camera_view_config_smoke"])
    run([python, "-m", "unittest", "-v", "tests.test_masked_camera_view_compare_smoke"])
    ...
    run([python, "-m", "unittest", "-v", "tests.test_io_case_ffs_raw_loader_smoke"])
