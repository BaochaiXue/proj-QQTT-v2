...
DEFAULT_OUTPUT_ROOT = ROOT / "data" / "experiments" / "enhanced_phystwin_removed_overlay_frame_0000"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=int,
        default=80_000,
        help="Deterministic per-camera sampling cap before fusing; use <=0 to disable.",
    )
    ...
    parser.add_argument("--highlight_scope", choices=("all", "radius", "component"), default="all")
...
def main() -> int:
    ...
    summary = run_enhanced_phystwin_removed_overlay_workflow(
        ...
        highlight_scope=str(args.highlight_scope),
