        ...
        for frame in frames:
            ...
            if str(panel_mode) == PANEL_MODE_SIDE_BY_SIDE:
                ...
                hud = SideBySidePanelHud(
                    ...
                    capture_fps=float(_as_float_or_none(frame.get("capture_fps")) or 0.0),
                    seg_fps=float(_as_float_or_none(frame.get("seg_fps")) or 0.0),
                    depth_fps=float(_as_float_or_none(frame.get("depth_fps")) or 0.0),
                    pcd_fps=float(_as_float_or_none(frame.get("pcd_fps")) or 0.0),
                    tracker_fps=float(_as_float_or_none(frame.get("tracker_fps")) or 0.0),
                    render_fps=float(_as_float_or_none(frame.get("render_fps")) or 0.0),
