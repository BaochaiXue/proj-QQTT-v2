...
class Demo21Runtime:
    ...
    def _write_summary(self) -> None:
        ...
        self._summary["final"] = {
            ...
            "object_points": None if latest is None else getattr(latest, "object_point_count", None),
            "controller_points": None if latest is None else getattr(latest, "controller_point_count", None),
