...
def build_shared_runtime_argv(
    ...
    *,
    ...
    for flag, value in (
        ...
        ("--object-postprocess", getattr(args, "object_postprocess", None)),
        ("--controller-postprocess", getattr(args, "controller_postprocess", None)),
        ...
        ("--phystwin-radius-m", getattr(args, "phystwin_radius_m", None)),
