...
def build_recording_metadata(
    *,
    ...
    return {
        ...
        "intrinsics": k_color,
        "K_color": k_color,
        "color_distortion_model": [m.get("color_distortion_model") for m in stream_metadata],
        "color_distortion_coeffs": [m.get("color_distortion_coeffs") for m in stream_metadata],
        "K_ir_left": [m.get("K_ir_left") for m in stream_metadata],
        "ir_left_distortion_model": [m.get("ir_left_distortion_model") for m in stream_metadata],
        "ir_left_distortion_coeffs": [m.get("ir_left_distortion_coeffs") for m in stream_metadata],
        "K_ir_right": [m.get("K_ir_right") for m in stream_metadata],
        "ir_right_distortion_model": [m.get("ir_right_distortion_model") for m in stream_metadata],
        "ir_right_distortion_coeffs": [m.get("ir_right_distortion_coeffs") for m in stream_metadata],
