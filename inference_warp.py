...
#         data_path=f"./data/real_collect/rope_double_hand/final_data.pkl",
#         base_dir=base_dir,
#     )
#     trainer.test(
#         "./past_exps/warp_rope_full/train/best_249.pth"
#     )
...
#     logger.set_log_file(path=base_dir, name="inv_phy_log")
#     trainer = InvPhyTrainerWarp(
#         data_path=f"./taichi_simulator_test/data_prepare/multiple_k_data_prepare/table_2k.npy",
#         base_dir=base_dir,
#     )
#     trainer.test(
#         "./past_exps/warp_table_full/train/best_499.pth"
#     )
