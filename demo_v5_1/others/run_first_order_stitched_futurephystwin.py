#!/usr/bin/env python3
"""Run FuturePhysTwin first-order optimization on the stitched Demo v5.1 case.
...
directory exported by ``export_stitched_case_for_futurephystwin.py``, then:
  ...
  3. copies the visualization videos into ``demo_v5_1/others``.
...
DEFAULT_VIDEOS_DIR = REPO_ROOT / "demo_v5_1/others"
SEED = 42
