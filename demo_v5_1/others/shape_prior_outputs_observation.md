# Demo v5.1 Shape Prior Outputs 观察记录
...
`/tmp/demo_v51_shape_prior_pcd_only_open3d.log`。
...
- `outputs/capture/shape_prior/points.npz`
...
发布出去的 `outputs/data/final_data.pkl` 当前是：
