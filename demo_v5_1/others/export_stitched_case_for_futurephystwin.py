#!/usr/bin/env python3
"""Export the stitched Demo v5.1 online result as a FuturePhysTwin case.
...
run for demo_v5_1, so the first-order stage reuses the sloth demo_v4 params).
"""
...
DEFAULT_CASE_NAME = "demo_v5_1_stitched_805"
DEFAULT_CASES_ROOT = REPO_ROOT / "demo_v5_1/others/futurephystwin_stitched/cases"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Export the stitched Demo v5.1 final_data as a FuturePhysTwin case "
