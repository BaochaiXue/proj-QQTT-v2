...
_EXPORT_TO_MODULE = {
    ...
    "DEFAULT_FFS_ENV_NAME": ".ffs_defaults",
    "DEFAULT_FFS_ENV_PYTHON": ".ffs_defaults",
    "DEFAULT_FFS_MAX_DISP": ".ffs_defaults",
    "DEFAULT_FFS_MODEL_NAME": ".ffs_defaults",
    "DEFAULT_FFS_MODEL_PATH": ".ffs_defaults",
    ...
    "DEFAULT_FFS_VALID_ITERS": ".ffs_defaults",
    ...
    "FFS_INPUT_STAGING_MODES": ".fast_foundation_stereo",
    "FFS_INPUT_STAGING_PAGEABLE": ".fast_foundation_stereo",
    "FFS_INPUT_STAGING_PINNED": ".fast_foundation_stereo",
