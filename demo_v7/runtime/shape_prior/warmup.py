...
from demo_v7.runtime.shape_prior.case import (
    ShapePriorFrame0Request,
    require_name,
    write_shape_prior_case,
)
from demo_v7.runtime.shape_prior import mesh_cache, sample as sample_stage
from demo_v7.runtime.shape_prior.mesh_cache import (
    ShapePriorMeshCache,
    normalize_object_id,
)
...
from demo_v7.runtime.shape_prior.timing import (
...
from demo_v7.runtime.utils.stage_prewarm import PRERENDER_DIRECTIVE_PREFIX
...
class ShapePriorLocalClient:
    ...
    def _stage_env(self) -> dict[str, str]:
        ...
        python_path = [str(REPO_ROOT), str(REPO_ROOT / "demo_v7" / "runtime")]
    ...
    def _stage_commands(self) -> dict[str, list[str]]:
        ...
        upscale = [
            sys.executable,
            "-m",
            "demo_v7.runtime.shape_prior.upscale",
            "--img_path",
        ...
        generate = [
            sys.executable,
            "-m",
            "demo_v7.runtime.shape_prior.generate",
            "--img_path",
        ...
        align = [
            sys.executable,
            "-m",
            "demo_v7.runtime.shape_prior.align",
            "--base_path",
            str(self.case_root),
            "--case_name",
            self.case_name,
        ...
        sample = [
            sys.executable,
            "-m",
            "demo_v7.runtime.shape_prior.sample",
            "--base_path",
            str(self.case_root),
            "--case_name",
            self.case_name,
    ...
    def request_shape_prior(self, frame0: ShapePriorFrame0Request) -> ShapePriorResult:
        ...
        if resolution.hit:
            ...
            from demo_v7.runtime.perception import (  # noqa: PLC0415
