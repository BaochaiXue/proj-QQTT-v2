...
from demo_v7.runtime.utils.camera import SUPPORTED_CAPTURE_FPS, parse_profile
from demo_v7.runtime.utils.ffs_align import validate_ffs_paths
...
def validate_and_normalize_args(args: argparse.Namespace) -> None:
    ...
    if bool(args.shape_prior_warmup):
        from demo_v7.runtime.shape_prior.mesh_cache import (  # noqa: PLC0415
