...
from demo_v7.runtime.utils.atomic_io import atomic_open
from demo_v7.runtime.utils.depth_geometry import transform_points
from demo_v7.runtime.utils.pcd_postprocess import detect_radius_outlier_indices
from demo_v7.runtime.utils.projection import (
    build_projection_grid_from_matrix,
    intrinsics_to_matrix,
)
from demo_v7.runtime.utils.render import (
    _load_rgb,
    _render_empty_video,
...
def finalize_headless_capture(
    ...
    *,
    ...
    from demo_v7.runtime import tracking as tracking_module  # noqa: PLC0415
    from demo_v7.runtime.streaming import window_observations  # noqa: PLC0415
