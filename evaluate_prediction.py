...
# prediction_dir = (
#     "./past_exps/only_second"
# )
# prediction_dir = (
#     "./experiments"
# )
prediction_dir = _resolve_path("./exp_results/GNN_original/different_types_gnn")
base_path = _resolve_path("./data/different_types")
output_file = _resolve_path("results/final_results_gnn_indomain.csv")
