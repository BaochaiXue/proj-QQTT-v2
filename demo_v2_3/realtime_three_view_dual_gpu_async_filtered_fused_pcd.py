...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    view.add_argument("--controller-render-max-points", type=int, default=None, help="Render-only controller body PCD maximum points.")
...
def _to_demo23_argv(argv: Sequence[str] | None) -> list[str]:
    ...
    _append_option(translated, "--controller-render-max-points", parsed.controller_render_max_points)
