...
def render_sets(dataset : ModelParams, iteration : int, pipeline : PipelineParams, skip_train : bool, skip_test : bool, separate_sh: bool, remove_gaussians: bool = False, exp_name: str = "dynamic"):
    with torch.no_grad():
        ...
        output_path = _resolve_path('./output_dynamic_gnn_special_case')
        ...
        dataset.source_path = os.path.join(_resolve_path("../../gaussian_data/"), source_name)
        dataset.model_path = os.path.join(_resolve_path("./output"), source_name, "init=hybrid_iso=True_ldepth=0.001_lnormal=0.0_laniso_0.0_lseg=1.0")
        ...
        ctrl_pts_path = _resolve_path('../gaussian-recon/gaussian-splatting/render-rope_e30_d10-model_50/rope_0/inference.pkl')
...
if __name__ == "__main__":
    ...
    with open(_resolve_path('./rendering_finished_dynamic_gnn.txt'), 'a') as f:
