output_dir="../gaussian-recon/gaussian-splatting/output_dynamic_out_domain"
output_dir_transfer="../gaussian-recon/gaussian-splatting/output_dynamic_out_domain_transfer"
