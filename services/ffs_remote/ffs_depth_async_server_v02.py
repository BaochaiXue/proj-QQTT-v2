    ...
    def run(self) -> None:
        ...
        while not self._stop_event.is_set():
            ...
            try:
                ...
                depths, per_camera_stats, warmup_remaining = self._run_request(
                    request=request,
                    runner=runner,
                    aligner=aligner,
                ...
                parts = build_reply_parts(
                    ...
                    server_total_ms=_elapsed_ms(request_started_s),
            ...
            elapsed_ms = _elapsed_ms(request_started_s)
        ...
        for camera in request.cameras:
            if warmup_remaining > 0:
                ...
                if bool(self._args.debug):
                    print(
                        "[demo-v0.2-async-server] "
                        f"worker={self.worker_idx} lazy_warmup count={warmup_remaining} "
