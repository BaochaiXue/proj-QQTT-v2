...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--gaussian_path",
        type=str,
        default=_resolve_path("./gaussian_splatting/output"),
    )
    parser.add_argument(
        "--bg_img_path",
        type=str,
        default=_resolve_path("./past_data_collect/bg/color/0/204.png"),
    )
    ...
    base_dir = _resolve_path(f"temp_experiments/{case_name}")
