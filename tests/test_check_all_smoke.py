...
class CheckAllSmokeTest(unittest.TestCase):
    ...
    def test_quick_profile_uses_curated_batched_commands(self) -> None:
        ...
        self.assertIn(["python", "scripts/harness/experiments/profile_demo31_tapnextpp_attention_kernels.py", "--help"], commands)
        ...
        self.assertIn(["python", "scripts/harness/profile_enhanced_pt_topn_surface_filter.py", "--help"], commands)
        ...
        self.assertIn("tests.test_demo31_tapnextpp_attention_profile", flat_items)
    ...
    def test_full_profile_keeps_pytest_and_broader_command_surface(self) -> None:
        ...
        self.assertNotIn(["python", "demo_v2_2/realtime_three_view_async_filtered_fused_pcd.py", "--help"], commands)
        self.assertNotIn(["python", "demo_v2_3/realtime_three_view_dual_gpu_async_filtered_fused_pcd.py", "--help"], commands)
