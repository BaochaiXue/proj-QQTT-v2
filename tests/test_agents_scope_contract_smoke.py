...
class AgentsScopeContractSmokeTest(unittest.TestCase):
    def test_agents_mentions_compare_scope_and_current_entrypoints(self) -> None:
        ...
        self.assertIn("scripts/harness/diagnostics/visualization/visual_compare_turntable.py", content)
        self.assertIn("scripts/harness/diagnostics/depth/visual_compare_depth_panels.py", content)
        self.assertIn("scripts/harness/diagnostics/depth/visual_compare_reprojection.py", content)
        self.assertIn("scripts/harness/diagnostics/depth/visual_compare_depth_triplet_ply.py", content)
        self.assertIn("scripts/harness/diagnostics/depth/visual_compare_depth_triplet_video.py", content)
        self.assertIn("scripts/harness/diagnostics/visualization/visual_compare_rerun.py", content)
    ...
    def test_agents_mentions_sanctioned_demo_proxy_scope(self) -> None:
        ...
        self.assertIn("scripts/harness/diagnostics/demo/realtime_single_camera_pointcloud.py", content)
