#!/usr/bin/env python3
"""Track visualization for Demo v6 object/controller point chunks.
...
DEFAULT_WINDOW_NAME = "Demo v6 visualize track"
...
def project_world_points_to_pixels(
    ...
    *,
    ...
    """Project world-space Demo v6 points back onto the selected RGB camera.
...
def build_parser() -> argparse.ArgumentParser:
    """Build the Demo v6 chunk viewer CLI parser."""
    parser = argparse.ArgumentParser(description="Play Demo v6 online object/controller points chunk by chunk.")
...
def main(argv: Sequence[str] | None = None) -> int:
    """Parse CLI arguments and run the Demo v6 viewer."""
    parser = build_parser()
