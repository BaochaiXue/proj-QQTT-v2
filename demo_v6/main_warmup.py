"""Main warmup helpers for Demo v6 realtime capture and perception."""
...
from demo_v6.utils.ffs_align import warm_up_numba_ffs_align
from demo_v6.utils.pcd_filter import AsyncPcdFilterWorker
from demo_v6.utils.projection import build_projection_grid
from demo_v6.utils.render import apply_wslg_open3d_env_defaults
...
def release_sam31_runtime_resources(device: str = DEFAULT_SAM31_DEVICE) -> float:
    ...
    from demo_v6 import sam31_image_segmentation
...
def run_sam31_first_frame_mask_bundle(
    ...
    from demo_v6.sam31_image_segmentation import (
        parse_text_prompts,
