...
DEFAULT_ARTIFACT_DIR = Path("demo_v6/others/obj_shape_asap_outputs")
DEFAULT_PREVIEW_VIDEO_PATH = DEFAULT_ARTIFACT_DIR / "shape_prior_lbs_preview.mp4"
DEFAULT_CONTACT_SHEET_PATH = Path(
    "demo_v6/others/obj_shape_asap_outputs/shape_prior_lbs_preview_sheet.png"
)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Render a static Demo v6 shape-prior orbit preview from the "
    ...
    parser.add_argument(
        ...
        help="Demo v6 outputs root. Defaults to ./outputs.",
    )
    parser.add_argument(
        "--case-name",
        type=str,
