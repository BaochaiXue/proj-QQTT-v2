#!/usr/bin/env python3
"""Render Demo v6 online depth frames with RealSense Dynamic Jet coloring."""
...
DEFAULT_ONLINE_DATA_DIR = Path("outputs_v6/online_data")
DEFAULT_OUTPUT_DIR = Path("demo_v6/others/obj_shape_asap_outputs")
DEFAULT_VIDEO_PATH = (
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Render Demo v6 online depth frames as a RealSense Dynamic Jet "
    ...
    parser.add_argument(
        ...
        help="Demo v6 online_data directory containing depth/ and metadata.",
    )
    parser.add_argument(
        "--output-video-path",
        type=Path,
