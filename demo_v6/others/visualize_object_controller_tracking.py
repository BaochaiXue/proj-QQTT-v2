#!/usr/bin/env python3
"""Render Demo v6 object/controller tracking chunks as an MP4.
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Visualize Demo v6 object/controller tracking from all online "
            "final_data chunks."
        )
    )
    parser.add_argument(
...
def render_tracking_video(
    ...
    *,
    ...
    window_created = visualizer.create_window(
        window_name="Demo v6 object/controller tracking",
        width=int(width),
        height=int(height),
        visible=False,
    )
    ...
    overlay_window_created = overlay_visualizer.create_window(
        window_name="Demo v6 object/controller tracking overlays",
        width=int(width),
        height=int(height),
        visible=False,
    )
