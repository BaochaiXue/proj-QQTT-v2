"""Publish Demo v6 chunks in the online final_data format.
...
from demo_v6.data_keys import TIME_KEYS
...
def build_chunk_data_record(
    ...
    *,
    ...
    # That path produces one final_data.pkl for a completed case. Demo v6
...
class ChunkDataWriter:
    ...
    def _append_static_data(self, data: Mapping[str, Any], *, frame_count: int) -> None:
        ...
        # Offline parity with data_process_sam3d/data_process_sample.py:L335-L352.
        # That path writes one static final_data.pkl. Demo v6 continuously
        ...
        metadata = {
            ...
            "runtime_product_name": "demo_v6_main_data_processing",
