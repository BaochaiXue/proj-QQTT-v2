...
CHECKPOINT_DIR = DEMO_DIR / "groundedSAM_checkpoints"
GROUNDING_DINO_CONFIG = str(CHECKPOINT_DIR / "GroundingDINO_SwinT_OGC.py")
GROUNDING_DINO_CHECKPOINT = str(CHECKPOINT_DIR / "groundingdino_swint_ogc.pth")
BOX_THRESHOLD = 0.35
TEXT_THRESHOLD = 0.25
