#!/usr/bin/env python3
"""Demo v6 main data processing runtime."""
# ---------------------------------------------------------------------------
...
from demo_v6.utils.camera import (  # noqa: E402
    CameraIntrinsics,
...
from demo_v6.utils.concurrency import (  # noqa: E402
    CoalescedPostGate,
    LatestSlot,
    elapsed_ms as _elapsed_ms,
    packet_seq as _packet_seq,
)
from demo_v6.utils.ffs_align import FfsIrToColorAligner, validate_ffs_paths  # noqa: E402
from demo_v6.utils.render import (  # noqa: E402
    Open3DSceneTensorLayer,
    RenderStats,
    load_open3d_modules,
)
from demo_v6.utils.pcd_filter import (  # noqa: E402
...
from demo_v6 import main_warmup  # noqa: E402
from demo_v6 import shape_prior_warmup  # noqa: E402
from demo_v6.tracking import CONTROLLER_FINAL_COUNT  # noqa: E402
from demo_v6.main_warmup import InitialMaskBundle  # noqa: E402
...
from demo_v6.utils.projection import lift_tracks_yx_to_world  # noqa: E402
from demo_v6.utils.query_rainbow import query_rainbow_colors_from_points_yx_rgb_u8  # noqa: E402
from demo_v6.phystwin_strict_product import (  # noqa: E402
...
from demo_v6.utils.side_by_side_panel import (  # noqa: E402
    SideBySidePanelHud,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Write input_rgb/*.png and input_frames.jsonl for Demo v6 realtime side-by-side viewing.",
    )
    ...
    def _apply_single_pcd_filter(
        ...
        *,
        ...
        if mode == PCD_FILTER_NONE:
            ...
            from demo_v6.utils.pcd_postprocess import (
