...
class ModelParams(ParamGroup):
    def __init__(self, parser, sentinel=False):
        ...
        self.pts_per_triangles = (
            30  # number of points per triangle sampled from the mesh to init gs
        )
        ...
        self.disable_sh = (
            False  # set to True if want to disable SH coefficients during rendering.
        )
        self.eval = False
