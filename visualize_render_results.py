...
# prediction_dir = "./exp_results/indomain_our/output_dynamic"
# prediction_dir = "./exp_results/GNN_render/output_dynamic_gnn"
prediction_dir = _resolve_path("./gaussian_splatting/output_dynamic")
human_mask_path = (
    _resolve_path("./data/different_types_human_mask")
)
object_mask_path = (
    _resolve_path("./data/render_eval_data")
)
